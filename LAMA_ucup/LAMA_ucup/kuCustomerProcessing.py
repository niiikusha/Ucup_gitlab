...
class KuCustomerProcessing:
    ...
    @staticmethod
    def create_ku_customer(customer, entity, period, date_start, status_ku, date_end=None, date_actual=None, graph_exists=None,
        ...
        entity = Entity.objects.get(entity_id=entity)
